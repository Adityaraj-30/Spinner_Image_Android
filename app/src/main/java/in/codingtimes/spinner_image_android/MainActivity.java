    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                {
                    case 0:{
                        imageView.setImageDrawable(getResources().getDrawable(R.drawable.tom_jerry));
                        break;
                    }
                    case 1:{
                        imageView.setImageDrawable(getResources().getDrawable(R.drawable.pikachu));
                        break;
                    }
                    case 2:{
                        imageView.setImageDrawable(getResources().getDrawable(R.drawable.ben10));
                        break;
                    }
                    case 3:{
